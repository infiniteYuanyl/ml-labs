...
#python test.py --data data/data.txt --split 0 --ckpg checkpoints/20230417_22_28_39_nv_bayes.npz
...
if __name__ == '__main__':
    ...
    net = NaiveBayes(dataloader = dataloader,load_checkpoint=args.ckpg)
    net.test()
